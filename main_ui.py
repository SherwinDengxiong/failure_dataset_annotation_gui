...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        background,action,attraction,objects,attrobject,response=readdict("dictionary.csv")
        # main window
        ...
        # self.ifbackgroundnon = QtWidgets.QLabel(self.basicInfoGroup)
        # self.basicInfo_formLayout.setWidget(
        #     5, QtWidgets.QFormLayout.LabelRole, self.ifbackgroundnon)
        # self.ifbackgroundnon = QtWidgets.QLineEdit(self.basicInfoGroup)
        #
        # self.ifbackgroundnon.setObjectName("startFrame_lineEdit")
        # self.basicInfo_formLayout.setWidget(
        #     5, QtWidgets.QFormLayout.FieldRole, self.ifbackgroundnon)
        ...
        for i in range(len(response)):
            self.weather_comboBox.addItem("")
        self.basicInfo_formLayout.setWidget(
            6, QtWidgets.QFormLayout.FieldRole, self.weather_comboBox)
        ...
        self.Right.setMaximumWidth(800)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ifDay_label.setText(_translate("MainWindow", "Background"))
        self.ifDay_comboBox.setItemText(0, _translate("MainWindow", "none"))
        for i in range(len(background)):
            self.ifDay_comboBox.setItemText(i+1, _translate("MainWindow", background[i]))
        # self.ifDay_comboBox.setItemText(0, _translate("MainWindow", "Yard or garden"))
        # self.ifDay_comboBox.setItemText(1, _translate("MainWindow", "Lawn"))
        # self.ifDay_comboBox.setItemText(2, _translate("MainWindow", "Stage"))
        # self.ifDay_comboBox.setItemText(3, _translate("MainWindow", "Track-and-field ground"))
        # self.ifDay_comboBox.setItemText(4, _translate("MainWindow", "Soccer play ground"))
        # self.ifDay_comboBox.setItemText(5, _translate("MainWindow", "Gym"))
        # self.ifDay_comboBox.setItemText(6, _translate("MainWindow", "Day"))
        # self.ifDay_comboBox.setItemText(7, _translate("MainWindow", "Night"))

        self.weather_label.setText(_translate("MainWindow", "Response action"))
        ...
        for i in range(len(response)):
            self.weather_comboBox.setItemText(i+1, _translate("MainWindow", response[i]))
        ...
        self.ifEgo_label.setText(_translate("MainWindow", "Action"))
        self.ifEgo_label.setStatusTip(
            "If ego car is involved in the car accident.")

        self.ifEgo_comboBox.setItemText(0, _translate("MainWindow", "none"))
        for i in range(len(action)):

            self.ifEgo_comboBox.setItemText(i+1, _translate("MainWindow", action[i]))

        # self.delEgoReasonBtn.setText(_translate("MainWindow", "Delete"))

        self.egoReason_label.setText(
            _translate("MainWindow", "Action attribute"))
        self.egoReason_comboBox.setItemText(
            0, _translate("MainWindow", "none"))
        for i in range(len(attraction)):
            self.egoReason_comboBox.setItemText(
                i+1, _translate("MainWindow", attraction[i]))
        # self.egoReason_comboBox.setItemText(
        ...
        self.setCrashStartBtn.setText(_translate(
            "MainWindow", "set as Failure Start Frame"))
        ...
        self.objType_label.setText(_translate("MainWindow", "Object"))
        self.objTypes_comboBox.setItemText(0, _translate("MainWindow", "none"))
        for i in range(len(objects)):

            self.objTypes_comboBox.setItemText(
                i+1, _translate("MainWindow", objects[i]))
        ...
        self.objReason_label.setText(_translate("MainWindow", "Object attribute"))
        self.objReason_comboBox.setItemText(
            0, _translate("MainWindow", "none"))
        for i in range(len(attrobject)):

            self.objReason_comboBox.setItemText(
                i+1, _translate("MainWindow", attrobject[i]))
        # self.objReason_comboBox.setItemText(
        #     2, _translate("MainWindow", "hard to define"))
        # self.objReason_comboBox.setItemText(
        #     3, _translate("MainWindow", "unclear view"))
        ...
        self.editObjBtn.setText(_translate("MainWindow", "Delete"))
